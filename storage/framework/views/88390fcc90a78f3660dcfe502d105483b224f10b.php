...
<div class="signupform">
            ...
            <div class="w3_info">
                ...
                <form  method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="input-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                        ...
                        <input type="email" placeholder="Enter Your Email" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
    ...
    <!-- footer -->
    <div class="footer">
        <p>&copy; 2020 . All Rights Reserved | Design by <a href="https://easyonline.ir/" target="blank">EasyOnline</a></p>
    </div>
    <!-- footer -->
</div>
